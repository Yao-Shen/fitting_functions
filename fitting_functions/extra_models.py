...
class LorentzianSq2DModel(Model):
    ...
    def __init__(self, independent_vars=['X', 'Y'], prefix='', nan_policy='omit',
                 **kwargs):
...
class LorentzianSq3DModel(Model):
    ...
    def __init__(self, independent_vars=['X', 'Y', 'Z'], prefix='', nan_policy='omit',
                 **kwargs):
        kwargs.update({'prefix': prefix, 'nan_policy': nan_policy,
                       'independent_vars': independent_vars})
...
class ErrorModel(Model):
    ...
    def __init__(self, prefix='', independent_vars=['x'], nan_policy='omit',
                 **kwargs):
        kwargs.update({'prefix': prefix, 'nan_policy': nan_policy,
                       'independent_vars': independent_vars})
